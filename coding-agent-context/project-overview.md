...
| F-005 | READY | Stage 1.1a: parse PDF/DOCX deterministically, normalize content, build the source ledger and bounded chunks, and persist canonical chunk records. | F-004 | Identical bytes yield identical document/chunk IDs, order, provenance, and checksums; UI emits truthful progress. |
